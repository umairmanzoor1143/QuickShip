...
export default function HowItWorks(){
    return(
        <main className="container mx-auto bg-[#0c0c0c] liner-gradient-2 text-center p-[40px] mt-[84px] mb-[148px]">
            <div>
                ...
                <Image className="mx-auto mb-[152px]" src={Lines} alt={'img'}/>
                <div className="flex items-center justify-center gap-[24px]  mb-[24px]">
                    <div className="icon-one relative text-center p-[24px]">
                    ...
                    <div className="icon-two relative text-center p-[24px]">
